...
public class Test {
    ...
    public String encodingByRSA(String info) throws Exception {
    ...
    public String decodingByRSA(String info) throws Exception{
        Cipher cipher = Cipher.getInstance(RSA_ALGORITHM);
    ...
    public static void main(String[] args) throws Exception {
        String info = "sadfa";
        Test test = new Test();
        String encodingStr = test.encodingByRSA(info);
        System.out.println(encodingStr);
        System.out.println("--------------------------------------------------------------");
        System.out.println(test.decodingByRSA(encodingStr));
    }
}
